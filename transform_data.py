...
if __name__ == "__main__":
    ...
    engine = create_engine('postgresql://postgres:542104372qwertY!@localhost:5432/dwh_digitalskola')

    conf_hadoop = connection.param_config("hadoop")["ip"]
    client = InsecureClient(conf_hadoop)

    with client.read(f'/DigitalSkola/{time}/users_{time}.csv', encoding='utf-8') as writer:
